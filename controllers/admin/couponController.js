...
exports.removeCoupon = async (req, res) => {
    try {
        ...
        if (!coupon) {
            return res.status(HttpStatus.NOT_FOUND).json({ status: 'error', message: 'Coupon not found' });
        }
        ...
        res.status(HttpStatus.BAD_REQUEST).json({ status: 'error', message: `Server error, ${error}` })
...
exports.editCoupon = async (req, res) => {
    try {
        ...
        return res.status(HttpStatus.BAD_REQUEST).json({ status: 'error', message: 'server error' })
    }
}
...
exports.editCouponPost = async (req, res) => {
    try {
        ...
        return res.status(HttpStatus.INTERNAL_SERVER_ERROR).json({ status: 'error', message: 'server error' })
    }
}