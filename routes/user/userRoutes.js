...
user_route.get('/orders/download-pdf/:orderId', pdfController.generateOrderPDF)

user_route.get('/orders/details/:orderId', userAuth.isLogin, orderController.orderDetails)
